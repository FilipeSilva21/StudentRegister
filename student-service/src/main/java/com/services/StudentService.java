...
public class StudentService {
    ...
    public Long createStudent(CreateStudentDTO createStudentDTO){
        ...
        if(createStudentDTO.name().length() < 5){
    ...
    public Student updateStudent(Long studentId, UpdateStudentDTO updateUserDTO) throws NotFoundException {
        ...
        if (studentEntity.isPresent()) {
            ...
            if(updateUserDTO.birthday() != null){
                student.setBirthday(updateUserDTO.birthday());
            }
